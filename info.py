...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/bNP.jpg') # Scanner Code image 
...
FILE_LIMITE = int(environ.get('FILE_LIMITE', 25))
...
VERIFY_API = (environ.get('VERIFY_API', '3b623c80e2c2534a5eae0bae35777c4c1aedd154'))

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "1800"))
VERIFY_URL2 = environ.get('VERIFY_URL2', 'arolinks.com')
VERIFY_API2 = (environ.get('VERIFY_API2', 'f565edfbea9e9a7e0ca7a758bbb580bf614d4487'))
 
THIRD_VERIFY_GAP = int(environ.get('THIRD_VERIFY_GAP', "1800"))
...
TUTORIAL2 = environ.get('TUTORIAL2', 'https://t.me/howtoopennlinks/25')
...
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002585601614)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002259958038)) # movies request channel, else log channel
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'marginal-cele-mzbotz-92904ee1.koyeb.app/'))
